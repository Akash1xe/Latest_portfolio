...
import {
  type Command,
  useCompetitiveProgrammingCommands,
  useLinuxCommands,
  useSectionCommands,
  useUtilityCommands,
} from "./use-command";
...
export const useTerminal = () => {
  ...
  const [output, setOutput] = useState<TerminalOutput[]>([
    {
      text: "Welcome to Akash's Terminal Portfolio! Type 'help' to see available commands.",
      isCommand: false,
      id: "welcome-1",
    },
    {
...
░▒▓█▓▒░░▒▓█▓▒░  ░▒▓████████▓▒░ ░▒▓████████▓▒░ ░▒▓████████▓▒░  ░▒▓██████▓▒░  
  ...
  const competitiveProgrammingCommands = useCompetitiveProgrammingCommands();
  ...
  const availableCommands = useMemo(() => {
    return {
      ...
      ...sectionCommands,
      ...utilityCommands,
      ...competitiveProgrammingCommands,
    };
  }, [linuxCommands, sectionCommands, utilityCommands, competitiveProgrammingCommands]);
