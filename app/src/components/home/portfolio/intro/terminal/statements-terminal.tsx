...
const qaPairs = [
  {
    question: "whoami",
    answer:
      "Backend developer building reliable services and scalable systems.",
  ...
  },
  {
    ...
    answer:
      "Working with C++, JavaScript, Node.js, Python, databases, Kafka, and Redis.",
  ...
  },
  {
    ...
    answer:
      "I love turning complex requirements into clean APIs and dependable systems.",
