...
const ProfileButtons: React.FC = () => {
  ...
  const socialLinks = content.profile.githubUrl ? [{
    icon: FaGithub,
    href: content.profile.githubUrl,
    label: "GitHub",
    color: "text-ctp-overlay1 hover:text-ctp-text",
    hoverBg: "hover:bg-ctp-surface1/80 hover:shadow-sm hover:shadow-ctp-surface2/20",
    linkClass: styles.githubLink,
    tooltip: { title: "GitHub Profile", description: "Explore my open-source code", emoji: "💻" },
  }] : [];
