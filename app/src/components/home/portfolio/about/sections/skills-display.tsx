      ...
      <div className="space-y-2 sm:space-y-3 md:space-y-4">
        {skills.map((skillCategory, index) => {
          const colors =
            ...
            ] ?? { primary: "blue", secondary: "sapphire" };
          const Icon =
            categoryIcons[skillCategory.category as keyof typeof categoryIcons] ?? Code2;
...
interface SkillsListProps { skillCategory: { category: string; skills: string[] } }
